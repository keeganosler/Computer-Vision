...
#this program analyzes a photograph of a sign, either a stop sign or a speed limit sign, then returns the image of the sign with either the speed limit or stop printed on it
